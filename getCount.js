 ...
 */
 function getCount(words) {
	var vowelCount=0,consCount=0, wordCount={};
	var wordStr = words.replace(/\s/g, '').toLowerCase();
	 for( var i = 0; i<wordStr.length;i++){
	 	if(wordStr[i].match(/[aeiou]/g)==null){
	 ...
	 wordCount.vowels = vowelCount;
	 wordCount.consonants = consCount ;
	 return wordCount;
}
